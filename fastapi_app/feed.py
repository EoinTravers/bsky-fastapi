...
from .type_definitions import FeedPost, FeedSkeleton
...
def feed_generator(cursor: Optional[str], limit: int) -> FeedSkeleton:
    return FeedSkeleton(cursor="none", feed=[FeedPost(post=post) for post in posts])
